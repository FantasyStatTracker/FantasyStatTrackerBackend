...
def update_roster_stats():
    ...
    if not skipAll:
        ...
        for x in range(1, lg.current_week()):
            ...
            for team in Prediction.winning_matchup:
                ...
                found = False
                for teamOpt in NameHistory[
                    TeamMapInverse[Matchup[x][edit_team_name(team)]]
                ]:
    ...
    Streak = {
        "Dead": {"L": 0, "T": 0, "W": 3},
        "JKimothy": {"L": 1, "T": 0, "W": 0},
        "Kentucky Jr.": {"L": 0, "T": 0, "W": 1},
        "Last Place Projected": {"L": 1, "T": 0, "W": 0},
        "LeAntiClutch": {"L": 0, "T": 0, "W": 1},
        "Liam's Squad of Goofy Goobers": {"L": 0, "T": 0, "W": 1},
        "Nathan's Phenomenal Team": {"L": 7, "T": 0, "W": 0},
        "Protocols P": {"L": 1, "T": 0, "W": 0},
        "Samuel's Tip-Top Team": {"L": 8, "T": 0, "W": 0},
        "Sufyan's Superb Team": {"L": 0, "T": 0, "W": 1},
        "Team Goon Cena": {"L": 0, "T": 0, "W": 6},
        "gae young": {"L": 1, "T": 0, "W": 0},
    }
